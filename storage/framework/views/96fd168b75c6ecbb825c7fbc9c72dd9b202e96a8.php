...
<div class="container">
    <div class="row">
            <div class="panel panel-default">
                <div class="panel-heading"><center><b><h1>Data Penggajian<center><b><h1></div>
                <div class="panel-body">

<a href="<?php echo e(url('Penggajian/create')); ?>" class="btn btn-primary form-control">Tambah Penggajian</a><br>
...
<tbody>
    <tr>
        ...
        <td>
            <a class="btn btn-warning" href="<?php echo e(route('Penggajian.show',$baru->id)); ?>">Rincian Gaji</a>
        </td>
        <td>
