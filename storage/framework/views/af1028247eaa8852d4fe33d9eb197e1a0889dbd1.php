        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <a href="<?php echo e(url('/Pegawai')); ?>" class="btn btn-warning btn-block">Kembali</a><br>
                    <center><img src="<?php echo e(asset('img/'.$pegawais->photo.'')); ?>" width="100" height="100" class="img-circle img-responsive" alt="Responsive image"></center><br>
                    <label>NIP</label>
                    ...
                    <input type="text" name="perission" placeholder="<?php echo e($pegawais->User->permission); ?>" class="form-control" disabled><br>
                </div>
            </div>
        </div>
    </div>
