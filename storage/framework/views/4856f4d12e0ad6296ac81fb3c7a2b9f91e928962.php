...
<div class="container">
    <div class="row">
            <div class="panel panel-default">
                <div class="panel-heading"><center><b><h1>Data Pegawai</h1></b></center></div>

                <div class="panel-body">
                    <a href="<?php echo e(url('/Pegawai/create')); ?>" class="btn btn-primary btn-block">Tambah Pegawai</a><br>
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $pegawais; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $baru): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo e(route('Pegawai.show',$baru->id)); ?>" class="btn btn-warning">Lihat</a></td>
                                    <td><a href="<?php echo e(route('Pegawai.edit',$baru->id)); ?>" class="btn btn-success">Ubah</a></td>
                                    <td>
