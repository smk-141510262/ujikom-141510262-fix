    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><center><b><h1>Data Jabatan</h1></b></center></div>

                <div class="panel-body">
                    <a href="<?php echo e(url('/Jabatan/create')); ?>" class="btn btn-primary btn-block">Tambah Data Jabatan</a><br>
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $jabatans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $baru): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo e(route('Jabatan.edit',$baru->id)); ?>" class="btn btn-success">Ubah</a></td>
                                    <td>
