    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><center><b><h1>Tambah Data Penggajian</h1></b></center></div>
                            ...
                            <div class="col-md-12">
                                <label for="tunjangan_pegawai_id">Nama Pegawai</label>
                                    <select class="col-md-6 form-control" name="tunjangan_pegawai_id" required>
                                        ...
                                        <?php $__currentLoopData = $tunjangans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
