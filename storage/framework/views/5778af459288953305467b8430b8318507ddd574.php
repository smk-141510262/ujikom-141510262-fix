    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><center><b><h1>Rincian Gaji</h1></b></center></div>
                ...
                <div class="">
                    ...
                    <center>
                        ...
                        <h4>
                            <center>
                                ...
                                <br><br>
                                Nama Jabatan : <br><b> <?php echo e($penggajians->tunjangan_pegawai->tunjangan->jabatan->nama_jabatan); ?> </b>
                                <br><br>
                                Nama Golongan : <br><b> <?php echo e($penggajians->tunjangan_pegawai->pegawai->golongan->nama_golongan); ?> </b>
                                <br><br>
                    ...
                    <table class="table table-striped table-hover ">
                     ...
                     <a class="btn btn-warning col-md-12" href="<?php echo e(url('Penggajian')); ?>">Kembali</a>
                </div>
                </div>
            </div>
        </div>
