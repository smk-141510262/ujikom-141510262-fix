    ...
    <div class="row">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <a href="<?php echo e(url('/KategoriLembur/create')); ?>" class="btn btn-primary btn-block">Tambah Data Kategori Lembur</a><br>
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $kategorilemburs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $baru): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo e(route('KategoriLembur.edit',$baru->id)); ?>" class="btn btn-success">Ubah</a></td>
                                    <td>
