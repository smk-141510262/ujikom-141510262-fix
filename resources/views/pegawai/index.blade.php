    ...
    <div class="row">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <a href="{{url('/Pegawai/create')}}" class="btn btn-primary btn-block">Tambah Pegawai</a><br>
                        ...
                        <tbody>
                            ...
                            @foreach ($pegawais as $baru)
                                <tr>
                                    ...
                                    <td><a href="{{route('Pegawai.show',$baru->id)}}" class="btn btn-warning">Lihat</a></td>
                                    <td><a href="{{route('Pegawai.edit',$baru->id)}}" class="btn btn-success">Ubah</a></td>
                                    <td>
