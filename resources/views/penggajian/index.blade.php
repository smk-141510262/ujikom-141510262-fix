...
<a href="{{url('Penggajian/create')}}" class="btn btn-primary form-control">Tambah Penggajian</a><br>
...
<tbody>
    <tr>
        ...
        <td>
            <a class="btn btn-warning" href="{{route('Penggajian.show',$baru->id)}}">Rincian Gaji</a>
        </td>
        <td>
