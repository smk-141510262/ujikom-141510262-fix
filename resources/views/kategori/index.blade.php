    ...
    <div class="row">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <a href="{{url('/KategoriLembur/create')}}" class="btn btn-primary btn-block">Tambah Data Kategori Lembur</a><br>
                        ...
                        <tbody>
                            ...
                            @foreach ($kategorilemburs as $baru)
                                <tr>
                                    ...
                                    <td><a href="{{route('KategoriLembur.edit',$baru->id)}}" class="btn btn-success">Ubah</a></td>
                                    <td>
